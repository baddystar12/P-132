...
sns.scatterplot(cluster_1_x, cluster_1_y, color = '#00cccc', label = 'Cluster 1')
sns.scatterplot(cluster_2_x, cluster_2_y, color = '#5900b3', label = 'Cluster 2')
sns.scatterplot(cluster_3_x, cluster_3_y, color = '#ff1a75', label = 'Cluster 3')
sns.scatterplot(cluster_4_x, cluster_4_y, color = '#009900', label = 'Cluster 4')
